...
const nukeFeedFollowsDB = `-- name: NukeFeedFollowsDB :exec
DELETE FROM feed_follows
`

func (q *Queries) NukeFeedFollowsDB(ctx context.Context) error {
	_, err := q.db.ExecContext(ctx, nukeFeedFollowsDB)
	return err
}
